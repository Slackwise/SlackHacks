  ...
  RETAIL = {
    HUNTER = {
      ...
      MARKSMANSHIP = {
        ...
        { "CTRL-4",           "spell",   "Explosive Shot" },
        { "5",                "spell",   "Kill Shot" },
        { "SHIFT-5",          "spell",   "Explosive Shot" },
    ...
    MAGE = {
      CLASS = {
        ...
        {"CTRL-F",            "spell",   "Dragon's Breath"},
        {"CTRL-SHIFT-F",      "spell",   "Polymorph"},
        {"G",                 "spell",   "Mirror Image"},
        ...
        {"SHIFT-C",           "spell",   "Frost Nova"},
        {"SHIFT-V",           "spell",   "Ice Block"},
