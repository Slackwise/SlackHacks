...
function Self:OnEnable()
  ...
  self:RegisterEvent("UNIT_SPELLCAST_START", "handleInterruptibleCast")
  self:RegisterEvent("UNIT_SPELLCAST_CHANNEL_START", "handleInterruptibleCast")
  self:RegisterEvent("UNIT_SPELLCAST_EMPOWER_START", "handleInterruptibleCast")
  self:RegisterEvent("UNIT_SPELLCAST_INTERRUPTIBLE", "handleInterruptibleCast")
